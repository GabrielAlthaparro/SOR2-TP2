...
int main (int argc, char *argv[])
{
  ...
  AnimationInterface anim("SOR2_dumbbell_topology_PUNTO_3.xml");
  ...
  pointToPointRouterCentral.EnablePcapAll("punto_3"); //filename without .pcap extention

  //Stream para CWND
  AsciiTraceHelper asciiTraceHelper;
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream("punto_3_nodo2_cwnd.txt");
  ...
  flowMonitor->SerializeToXmlFile("FlowMonitor_dumbell_Punto3.xml", true, true);
